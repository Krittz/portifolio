...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-[50px] left-0 right-0 flex justify-center z-50">
      <div className="bg-white/5 shadow-lg shadow-slate-800/20 rounded-2xl px-6 py-4 md:px-12 flex items-center justify-center md:w-[451px] w-full max-w-[calc(100%-24px)] outline outline-slate-800">
